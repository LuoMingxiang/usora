...
import { transitionActivityState } from "../../plugins/foundry/src/core/activities.ts";
import { buildActivityFingerprint } from "../../plugins/foundry/src/core/intelligence/fingerprint.ts";
...
const benchmarkScript = path.resolve("scripts/foundry-token-benchmark.ts");
...
test("foundry token benchmark reports repeatable baseline dimensions", async (t) => {
  ...
  const child = spawn(bunCommand, [benchmarkScript], {
    cwd: path.resolve("."),
