...
Use `hub_init`, `hub_status`, `hub_cleanup`, `candidate_create`, `candidate_evaluate`, and `skill_publish` through MCP. Never ask the user to install Python or run a CLI.
